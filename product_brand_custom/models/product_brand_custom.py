...
class ProductBrand(models.Model):
  ...
  company_id = fields.Many2one(
        ...
        ondelete='restrict')
  company_name = fields.Char(string='Name of the project', related='company_id.name')
  company_logo = fields.Binary(string="Project Logo",related="company_id.logo")
  ...
  company_sale_note = fields.Text(string="Terms and Conditions",related='company_id.sale_note',
                                  help="Little description on the delivery time and method, warranty and your sales conditions.")
  ...
  discount = fields.Boolean(string="This brand has some product in the 1:1 discount campaign.", default=False)
